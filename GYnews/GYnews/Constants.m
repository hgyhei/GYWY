...
#import "Constants.h"
NSString * const GYSortitemViewTitleArrayChangeNotification = @"GYSortitemViewTitleArrayChangeNotification";
NSString * const GYSortitemViewcutTitleArrayNotification = @"GYSortitemViewcutTitleArrayNotification";
NSString * const GYNewsTablecellClickNotification = @"GYNewsTablecellClickNotification";
